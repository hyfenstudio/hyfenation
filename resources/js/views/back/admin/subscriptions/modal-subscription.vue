<template>
    <v-modal ref="modal">
        <div class="bg-white rounded-lg overflow-hidden shadow-xl transform transition-all sm:max-w-lg sm:w-full">
            ...
            <div class="p-6">
                <h3 class="font-medium text-lg">Subscription Details</h3>
            </div>
            ...
            <div class="p-6">
                <dl class="grid grid-cols-1 col-gap-4 row-gap-8 sm:grid-cols-2">
                    ...
                    <div class="sm:col-span-1">
                        ...
                        <dd class="mt-1 text-sm leading-5 text-gray-900">
                            <span class="badge badge-green" v-if="subscription && subscription.status === 1">Active</span>
                            <span class="badge badge-yellow" v-else-if="subscription && subscription.status === 2">Past Due</span>
                            <span class="badge" v-else-if="subscription && subscription.status === 3">Canceled</span>
                            <span class="badge badge-red" v-else-if=" subscription &&subscription.status === 4">Incomplete</span>
                            <span v-else>-</span>
                        </dd>
                    </div>
