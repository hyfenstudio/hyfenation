        ...
        <div class="bg-white rounded-lg shadow-xl transform transition-all sm:max-w-xl sm:w-full">
            ...
            <div class="flex items-center px-6 pb-6 pr-6">
                ...
                <v-dropdown placement="left-0">
                    ...
                    <template v-slot:content>
                        <v-input-date inline v-model="task.due_date" @input="updateTask()"></v-input-date>
                    </template>
                </v-dropdown>
            ...
            <v-tabs>
                <v-tab class="p-6" name="Comments" active>
                    <v-tab-comments
                        :task-uuid="taskUuid"
                ...
                <v-tab class="p-6" name="Attachments">
                    <v-tab-attachments
                        :task-uuid="taskUuid"
                        :project-uuid="projectUuid"
                        ref="tab_attachments"
