    ...
    <v-modal ref="modal">
        <form class="bg-white rounded-lg overflow-hidden shadow-xl transform transition-all sm:max-w-lg sm:w-full">
            ...
            <div class="flex justify-between p-6">
                <h3 class="font-medium text-lg">Add Credit Card</h3>
            </div>

            <div class="px-6" v-if="hasError">
                <v-alert variant="failure" dismissible>Unable to add your credit card. Please try again.</v-alert>
            </div>

            <div class="px-6">
                <v-alert variant="warning" dismissible>Your credit card will NOT be stored in our servers.</v-alert>
            </div>
