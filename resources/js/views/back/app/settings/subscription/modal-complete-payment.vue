    ...
    <v-modal ref="modal">
        <form class="bg-white rounded-lg overflow-hidden shadow-xl transform transition-all sm:max-w-lg sm:w-full">
            ...
            <div class="flex justify-between p-6">
                <h3 class="font-medium text-lg">Complete Payment</h3>
            </div>

            <div class="p-6">
                <v-alert variant="failure" v-if="hasErrors">
                    Processing the payment was failed. Please try again.
                </v-alert>

                <p class="mb-4">
                    Please complete a payment of
                    <span class="font-medium">${{ amount }}</span> to activate the subscription.
                </p>
