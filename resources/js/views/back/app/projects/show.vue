                    ...
                    <template v-slot:content>
                        <div class="w-48 rounded-md bg-white shadow-xs">
                            <div class="py-1">
                                ...
                                >
                                    <span v-if="project.status === 'archived'">Delete</span>
    ...
    export default {
        ...
        methods: {
            ...
            showDeleteColumnModal(column) {
                this.$confirm('Do you want to permanently delete this column?', {
                    confirmText: 'Delete'
                }).then((modal) => {
            ...
            showDeleteProjectModal() {
                ...
                if (this.project.status === 'archived') {
                    message = `Do you want to permanently delete ${this.project.name}?`;
                    confirmButtonText = 'Delete';
                } else {
                    message = `Do you want to archive ${this.project.name}?`;
            ...
            showRestoreProjectModal() {
                this.$confirm('Do you want to restore this project?', {
