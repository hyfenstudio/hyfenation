            ...
            <div class="container mx-auto flex flex-col flex-1 px-4 sm:px-6 md:px-8 py-4">
                    ...
                    <div class="w-full sm:w-1/2">
                        <div class="mt-1 flex rounded-md shadow-sm">
                            <div class="relative flex-grow focus-within:z-10">
                                ...
                                <input class="form-input block w-full rounded-none rounded-l-md pl-10 transition ease-in-out duration-150 sm:text-sm sm:leading-5" placeholder="Search.." v-model="filtersForm.search"/>
                            </div>
                                ...
                                <div class="px-6 py-4 flex items-center">
                                    <div class="min-w-0 flex-1 md:grid md:grid-cols-8 md:gap-4">
                                        ...
                                        <div class="mt-2 md:col-span-2 sm:mt-0">
                                            <div>
                                                <div class="flex items-center text-sm leading-5 text-gray-500">
                                                    ...
                                                    <span class="font-medium">{{ project.pending_tasks }}</span>&nbsp;Tasks Left
                                                </div>
                                                ...
                                                <div class="mt-2 flex items-center text-sm leading-5 text-gray-500">
                                                    ...
                                                    <span v-if="project.days_left && project.days_left > 0">
                                                         <span class="font-medium">{{ project.days_left }}</span> days left
                                                    </span>
                                        ...
                                        <div class="mt-2 flex items-center md:col-span-1 sm:mt-0">
                                            <span class="badge badge-indigo" v-if="project.status === 'ongoing'">Ongoing</span>
                                            <span class="badge badge-red" v-else-if="project.status === 'overdue'">Overdue</span>
                                            <span class="badge badge-green" v-else-if="project.status === 'completed'">Completed</span>
                ...
                <div class="flex justify-center mt-6" v-else>
                    <div class="flex flex-col items-center">
                        <v-empty-view message="There are no projects to show here"/>
                    </div>
                </div>
            </div>
        </template>
