            ...
            <div class="flex flex-col h-full px-4 overflow-y-auto">
                <div class="flex flex-col mb-4 mt-1" v-if="addTaskForm.visible">
                    ...
                    <div class="flex justify-end mt-3">
                        <button @click="hideAddTaskForm()" class="btn btn-link text-xs px-4 py-1 mr-2" type="button">Cancel</button>
                        <button :disabled="addTaskForm.content === null" @click="storeTask()" class="btn btn-blue text-xs px-4 py-1" type="button">Submit</button>
                    </div>
                </div>
